...
public class Add implements Controller
{
    ...
    /**
     * Constructs this Add Component. Does NOT call make().
     ...
     */
    public Add(BasicStatsModel statsMod, Composite comp)
    {
        model = statsMod;
        composite = comp;
    }
    ...
    /**
     * Creates a JButton for the user to press to add a value to the model.
     * 
    ...
    public Container make() {
        ...
        button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				model.lastUpdateReasonIsAdd = true;
    ...
    public EnumMap<Element, Object> getElements() throws IllegalAccessException {
        ...
        rets.put(Element.ADDBUTTON, button);
        return rets;
    }
}
